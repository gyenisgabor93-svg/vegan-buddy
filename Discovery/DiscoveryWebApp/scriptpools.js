...
1: {  
  ...
  diet: "omnivore",
  title: {
    en: "Taking an animal’s life",
    es: "Quitar la vida a un animal",
    hu: "Egy állat életének elvétele",
  },
  lesson: {
    en: `
<p>Would you feel comfortable killing an animal yourself in order to eat it?</p>

<p>Many people feel unsure about this — even if they eat meat regularly.</p>

<p>Today, most of us don’t have to make that choice directly. Someone else does it for us.</p>

<p>This raises an interesting thought: is there a real difference between doing it ourselves, or asking someone else to do it on our behalf?</p>
`,
    es: `
<p>¿Te sentirías cómodo matando a un animal tú mismo para comerlo?</p>

<p>Muchas personas no están seguras — incluso si comen carne regularmente.</p>

<p>Hoy en día, la mayoría no tiene que tomar esa decisión directamente. Otra persona lo hace por nosotros.</p>

<p>Esto plantea una idea interesante: ¿hay una diferencia real entre hacerlo nosotros mismos o pedirle a alguien que lo haga en nuestro lugar?</p>
`,
    hu: `
<p>Kényelmesen éreznéd magad, ha saját magadnak kellene megölnöd egy állatot azért, hogy megedd?</p>

<p>Sokan bizonytalanok ebben — még akkor is, ha rendszeresen esznek húst.</p>

<p>Ma már a legtöbbünknek nem kell ezt közvetlenül megtennie. Valaki más teszi meg helyettünk.</p>

<p>Ez felvet egy érdekes kérdést: van valódi különbség aközött, hogy mi tesszük meg, vagy megkérünk valaki mást, hogy tegye meg helyettünk?</p>
`
  }
},
/*
...
21: {  
  ...
  diet: "vegetarian",  
  title: {
    en: "What does harm mean?",
    es: "¿Qué significa hacer daño?",
    hu: "Mivel ártunk?"
  },
  lesson: {
    en: `
    <p>When we think about harming an animal, we often imagine a single moment — the moment of death.</p>

    <p>But harm can also happen over time.</p>

    <p>So a question arises:</p>

    <p>Is it worse to die earlier — or to spend years in confined conditions before that moment?</p>

    <p>There isn’t one simple answer. But it invites us to reflect on what matters in an animal’s life.</p>
    `,
    es: `
    <p>Cuando pensamos en hacer daño a un animal, solemos imaginar un solo momento — el momento de la muerte.</p>

    <p>Pero el daño también puede ocurrir con el tiempo.</p>

    <p>Así surge una pregunta:</p>

    <p>¿Es peor morir antes — o pasar años en condiciones de confinamiento antes de ese momento?</p>

    <p>No hay una única respuesta. Pero nos invita a reflexionar sobre qué importa en la vida de un animal.</p>
    `,
    hu: `
    <p>Amikor az állatoknak okozott ártásra gondolunk, gyakran egyetlen pillanatra gondolunk — a halál pillanatára.</p>

    <p>De az ártás történhet idővel is.</p>

    <p>Így felmerül egy kérdés:</p>

    <p>Mi a rosszabb — hamarabb meghalni, vagy éveket tölteni egy ketrecben a halál előtt?</p>

    <p>Nincs egyetlen egyszerű válasz. De elgondolkodhatunk azon, mi számít egy állat életében.</p>
    `
  }
},
/*
...
41: {  
  ...
  title: {
    ...
    hu: "A tőlünk telhető legjobb"
  },
  lesson: {
    en: `
    <p>Every situation is different.</p>

    <p>For some people, going fully vegan is simple. For others, it can be limited by health, access, work, or responsibilities.</p>

    <p>There are also cases where certain products or medications may not have clear alternatives.</p>

    <p>This is why many people see veganism not as perfection, but as an effort — reducing harm as far as realistically possible.</p>

    <p>It’s not about judging each other, but about doing our best within our own circumstances.</p>
    `,
    es: `
    <p>Cada situación es diferente.</p>

    <p>Para algunas personas, ser completamente vegano es sencillo. Para otras, puede estar limitado por la salud, el acceso, el trabajo o responsabilidades.</p>

    <p>También hay casos en los que ciertos productos o medicamentos no tienen alternativas claras.</p>

    <p>Por eso muchas personas ven el veganismo no como perfección, sino como un esfuerzo — reducir el daño en la medida de lo posible.</p>

    <p>No se trata de juzgarnos, sino de hacer lo mejor posible dentro de nuestras circunstancias.</p>
    `,
    hu: `
    <p>Minden helyzet más.</p>

    <p>Van, akinek a teljesen vegán életmód egyszerű. Másoknál ezt befolyásolhatja az egészség, a hozzáférés, a munka vagy felelősségek.</p>

    <p>Vannak olyan esetek is, amikor bizonyos termékeknek vagy gyógyszereknek nincs egyértelmű alternatívája.</p>

    <p>Ezért sokan a veganizmust nem tökéletességként, hanem törekvésként látják — a lehetőségekhez mérten csökkenteni az ártalmat.</p>

    <p>Nem az egymás megítéléséről szól, hanem arról, hogy a saját helyzetünkben a tőlünk telhető legjobbat tegyük.</p>
    `
  }
},
/*
...
*/
  ...
  diet: "omnivore",  
    title: {
    en: "The rarely mentioned food industry",
    es: "La industria alimentaria que rara vez se menciona",
    hu: "A ritkán említett élelmiszeripar"
  },
  lesson: {
    en: `
    <p>When we talk about environmental issues, we often think about transport, energy, or plastic.</p>

    <p>Food is mentioned less often — even though it is one of the largest industries and has a major impact on the environment.</p>

    <p>Of course, not eating is not an option.</p>

    <p>But different foods can have very different environmental footprints.</p>

    <p>This means our daily food choices can be one of the ways we influence our impact on the planet.</p>
    `,
    es: `
    <p>Cuando hablamos de problemas ambientales, solemos pensar en el transporte, la energía o el plástico.</p>

    <p>La alimentación se menciona menos — aunque es una de las industrias más grandes y con gran impacto en el medio ambiente.</p>

    <p>Por supuesto, no comer no es una opción.</p>

    <p>Pero diferentes alimentos pueden tener impactos ambientales muy distintos.</p>

    <p>Esto significa que nuestras elecciones diarias pueden ser una forma de influir en nuestro impacto en el planeta.</p>
    `,
    hu: `
    <p>Amikor környezeti problémákról beszélünk, gyakran a közlekedésre, az energiára vagy a műanyagra gondolunk.</p>

    <p>Az élelmiszer ritkábban kerül szóba — pedig az egyik legnagyobb iparág, és jelentős hatással van a környezetre.</p>

    <p>Természetesen nem opció, hogy ne együnk.</p>

    <p>De a különböző ételek környezeti hatása nagyon eltérő lehet.</p>

    <p>Ez azt jelenti, hogy a mindennapi ételválasztásaink egy módja lehet annak, hogy hatással legyünk a bolygóra.</p>
    `
  }
},
/*
...
1040: {
  ...
  */
  ...
  lesson: {
    en: `
    <p>When we talk about environmental issues, food is often not the first thing people think about.</p>

    <p>Yet different foods can have very different overall environmental impacts — including land use, water use, emissions, and effects on biodiversity.</p>

    <p>On average, plant-based foods tend to have around <strong>70–90% lower environmental impact</strong> than many animal-based foods.</p>
    `,
    es: `
    <p>Cuando hablamos de problemas ambientales, la comida no suele ser lo primero en lo que pensamos.</p>

    <p>Sin embargo, diferentes alimentos pueden tener impactos ambientales muy distintos — incluyendo el uso de tierra, el agua, las emisiones y la biodiversidad.</p>

    <p>En promedio, los alimentos de origen vegetal suelen tener alrededor de un <strong>70–90% menos de impacto ambiental</strong> que muchos alimentos de origen animal.</p>
    `,
    hu: `
    <p>Amikor környezeti problémákról beszélünk, az élelmiszer nem mindig az első dolog, ami eszünkbe jut.</p>

    <p>Pedig a különböző ételek környezeti hatása nagyon eltérő lehet — beleértve a földhasználatot, a vízhasználatot, a kibocsátásokat és a biodiverzitásra gyakorolt hatást.</p>

    <p>A növényi alapú élelmiszerek átlagosan körülbelül <strong>70–90%-kal kisebb környezeti terheléssel</strong> járhatnak, mint sok állati eredetű élelmiszer.</p>
    `
  },
  source: "https://www.theguardian.com/environment/2023/jul/20/vegan-diet-cuts-environmental-damage-climate-heating-emissions-study"
},
/*
1042: {  
  goal: "Caring for the environment & fighting climate change",  
...
2001: {  
  ...
  diet: "omnivore",  
  title: {
    en: "A changing perspective",
    es: "Una perspectiva cambiante",
    hu: "Egy változó nézőpont"
  },
  lesson: {
    en: `
<p>Although modern science classifies humans as omnivores, this wasn’t always so clearly defined.</p>

<p>In the 18th century, before modern nutritional science, the naturalist Carl Linnaeus explored grouping humans with “fructivores,” partly based on traits like our teeth and similarities to other primates.</p>

<p>While his ideas were not final and even included mixed views, it shows that how we understand the human diet has evolved over time.</p>
`,
    es: `
<p>Aunque la ciencia moderna clasifica a los humanos como omnívoros, esto no siempre estuvo tan claramente definido.</p>

<p>En el siglo XVIII, antes de la ciencia nutricional moderna, el naturalista Carl Linnaeus exploró agrupar a los humanos con los “frugívoros”, en parte basándose en características como nuestros dientes y similitudes con otros primates.</p>

<p>Aunque sus ideas no eran definitivas e incluían puntos de vista mixtos, esto muestra que nuestra comprensión de la dieta humana ha evolucionado con el tiempo.</p>
`,
    hu: `
<p>Bár a modern tudomány az embert mindenevőként sorolja be, ez nem volt mindig ennyire egyértelmű.</p>

<p>A 18. században, a modern táplálkozástudomány előtt, Carl Linnaeus természettudós vizsgálta annak lehetőségét, hogy az embereket a „gyümölcsevők” közé sorolja, részben a fogazatunk és más főemlősökhöz való hasonlóságaink alapján.</p>

<p>Bár elképzelései nem voltak véglegesek, és vegyes nézeteket is tartalmaztak, jól mutatja, hogy az emberi étrendről alkotott képünk az idő során folyamatosan fejlődött.</p>
`
  },
...
export const extralessonsData = {
  ...
  },
  {
   ...
   {
    title: {
      en: "Nature by Numbers — The Golden Ratio",
      es: "La naturaleza por números — La proporción áurea",
      hu: "Természet számokkal — Az aranyarány"
    },
    content: {
    en: `🌀 The golden ratio (φ ≈ 1.618) is a special number connected to the Fibonacci sequence (1, 1, 2, 3, 5, 8, 13…).
When dividing consecutive Fibonacci numbers, the result gets closer to this ratio.

🌿 In nature, similar patterns appear in sunflowers, pinecones, shells, and leaf arrangements.
These forms are not chosen consciously.

🌻 Instead, simple growth rules naturally lead to highly efficient structures:
• Seeds pack tightly without gaps  
• Leaves avoid blocking each other’s light  
• Space and resources are used optimally  

Nature doesn’t calculate — but through evolution and physics, it arrives at efficient solutions that resemble mathematical patterns.`,

    es: `🌀 La proporción áurea (φ ≈ 1,618) es un número especial relacionado con la sucesión de Fibonacci (1, 1, 2, 3, 5, 8, 13…).
Al dividir números consecutivos de Fibonacci, el resultado se acerca a este valor.

🌿 En la naturaleza, patrones similares aparecen en girasoles, piñas, conchas y la disposición de las hojas.
Estas formas no se eligen conscientemente.

🌻 En cambio, reglas simples de crecimiento conducen naturalmente a estructuras muy eficientes:
• Las semillas se empaquetan sin dejar huecos  
• Las hojas evitan bloquear la luz entre sí  
• El espacio y los recursos se utilizan de forma óptima  

La naturaleza no calcula, pero a través de la evolución y la física, llega a soluciones eficientes que se parecen a patrones matemáticos.`,

    hu: `🌀 Az aranyarány (φ ≈ 1,618) egy különleges szám, amely kapcsolódik a Fibonacci-sorozathoz (1, 1, 2, 3, 5, 8, 13…).
Ha egymást követő Fibonacci-számokat osztunk, az eredmény egyre közelebb kerül ehhez az értékhez.

🌿 A természetben hasonló minták jelennek meg napraforgókban, tobozokban, kagylókban és a levelek elrendezésében.
Ezeket a formákat nem tudatosan választják.

🌻 Ehelyett egyszerű növekedési szabályok természetesen vezetnek rendkívül hatékony struktúrákhoz:
• A magok hézagok nélkül rendeződnek  
• A levelek nem árnyékolják egymást  
• A tér és az erőforrások optimálisan vannak kihasználva  

A természet nem számol, de az evolúció és a fizika révén olyan hatékony megoldásokhoz jut, amelyek matematikai mintákra emlékeztetnek.`
  },
    question: {
      text: {
        en: "What is the main reason Fibonacci patterns and the golden ratio appear in nature?",
        es: "¿Cuál es la razón principal por la que los patrones de Fibonacci y la proporción áurea aparecen en la naturaleza?",
        hu: "Miért jelentkeznek a Fibonacci-sorozat és az aranyarány a természetben?"
      },
      options: {
        en: [
          "Plants consciously choose the most beautiful patterns",
          "These patterns are random and have no real purpose",
          "Simple growth rules lead to efficient organization of space and resources",
          "Animals and plants learn these patterns over time"
        ],
        es: [
          "Las plantas eligen conscientemente los patrones más bellos",
          "Estos patrones son aleatorios y no tienen un propósito real",
          "Reglas simples de crecimiento conducen a una organización eficiente del espacio y los recursos",
          "Los animales y las plantas aprenden estos patrones con el tiempo"
        ],
        hu: [
          "A növények tudatosan a legszebb mintákat választják",
          "Ezek a minták véletlenszerűek és nincs valódi céljuk",
          "Egyszerű növekedési szabályok vezetnek hatékony tér- és erőforrás-szervezéshez",
          "Az állatok és növények ezt a mintákat idővel tanulják meg"
        ]
      },
      correctIndex: 2
    }
  ...
  },
{
  ...
  {
    title: {
      en: "Sixth mass extinction",
      es: "Sexta extinción masiva",
      hu: "Hatodik tömeges kihalás"
    },
    content: {
      en: "A mass extinction is when at least 75% of all species on Earth disappear in a relatively short period of time (in geological terms—thousands of years). Scientists have identified five mass extinctions in the past. The most famous is the Cretaceous–Paleogene extinction, which wiped out the dinosaurs around 66 million years ago. It was likely caused by a massive asteroid impact, combined with volcanic activity and rapid climate change. Although the event itself was sudden, the extinction unfolded over thousands of years, as ecosystems collapsed and species gradually disappeared.\n\nToday, many scientists believe we are entering a sixth mass extinction—but this time, the cause is not an asteroid. It’s us.\n\nSince 1970, wildlife populations have declined by about 69% on average - 12–15% of all species are currently threatened with extinction. The extinction that wiped out the dinosaurs unfolded over thousands of years. Today, similar ecological collapse is happening within just decades.",
      es: "Una extinción masiva ocurre cuando al menos el 75% de todas las especies de la Tierra desaparecen en un periodo relativamente corto de tiempo (en términos geológicos—miles de años). Los científicos han identificado cinco extinciones masivas en la historia de la Tierra. La más famosa es la extinción del Cretácico–Paleógeno, que acabó con los dinosaurios hace unos 66 millones de años. Probablemente fue causada por el impacto de un gran asteroide, junto con actividad volcánica y cambios climáticos rápidos. Aunque el evento en sí fue repentino, la extinción se desarrolló durante miles de años, a medida que los ecosistemas colapsaban y las especies desaparecían gradualmente.\n\nHoy, muchos científicos creen que estamos entrando en una sexta extinción masiva, pero esta vez la causa no es un asteroide. Somos nosotros.\n\nDesde 1970, las poblaciones de vida silvestre han disminuido aproximadamente un 69% en promedio - 12% y el 15% de todas las especies están actualmente amenazadas de extinción. La extinción que acabó con los dinosaurios ocurrió durante miles de años. Hoy, un colapso ecológico similar está ocurriendo en solo unas décadas.",
      hu: "A tömeges kihalás azt jelenti, hogy a Föld összes fajának legalább 75%-a eltűnik egy viszonylag rövid idő alatt(geológiai értelemben – több ezer év alatt). A tudósok eddig öt tömeges kihalást azonosítottak a Föld történetében. A legismertebb a kréta–paleogén kihalás, amely körülbelül 66 millió évvel ezelőtt kipusztította a dinoszauruszokat. Valószínűleg egy hatalmas aszteroida becsapódása, vulkanikus aktivitás és gyors klímaváltozás okozta. Bár maga az esemény hirtelen történt, a kihalás több ezer év alatt zajlott le, ahogy az ökoszisztémák összeomlottak, és a fajok fokozatosan eltűntek\n\nMa sok tudós úgy véli, hogy egy hatodik tömeges kihalás küszöbén állunk – de ezúttal nem egy aszteroida az ok. Hanem mi.\n\n1970 óta a vadon élő állatpopulációk átlagosan körülbelül 69%-kal csökkentek - a fajok 12–15%-a jelenleg a kihalás veszélyének van kitéve. A dinoszauruszokat kipusztító esemény több ezer év alatt zajlott le. Ma hasonló ökológiai összeomlás néhány évtized alatt történik."
    },
    question: {
      text: {
        en: "What is a mass extinction?",
        es: "¿Qué es una extinción masiva?",
        hu: "Mi az a tömeges kihalás?"
      },
      options: {
        en: [
          "When 10% of species disappear in a short time",
          "When ecosystems slowly change over millions of years",
          "When at least 75% of species disappear in a relatively short geological period",
          "When only large animals go extinct"
        ],
        es: [
          "Cuando desaparece el 10% de las especies en poco tiempo",
          "Cuando los ecosistemas cambian lentamente durante millones de años",
          "Cuando al menos el 75% de las especies desaparecen en un periodo geológico relativamente corto",
          "Cuando solo se extinguen los animales grandes"
        ],
        hu: [
          "Amikor a fajok 10%-a eltűnik rövid idő alatt",
          "Amikor az ökoszisztémák lassan, több millió év alatt változnak",
          "Amikor a fajok legalább 75%-a eltűnik egy viszonylag rövid geológiai időszak alatt",
          "Amikor csak a nagy állatok halnak ki"
        ]
      },
      correctIndex: 2
    },
    source: "https://www.worldwildlife.org/resources/explainers/what-is-the-sixth-mass-extinction-and-what-can-we-do-about-it/"
  },
  {
    title: {
...
export const onboardingFlow = {
  omnivore: [5001, 5002],
  vegetarian: [5003, 5004],
  pescatarian: [5005, 5006],
  flexitarian: [5007, 5008],
  intransition: [5009, 5010],
  vegan: [5011, 5012]
};

export const onboardingFlowSecond = {
  omnivore: [6001, 6002],
  vegetarian: [6003, 6004],
  pescatarian: [6005, 6006],
  flexitarian: [6007, 6008],
  intransition: [6009, 6010],
  vegan: [6011, 6012]
};

export const onboardingLessonPool = {
 5001: {  
  goal: "Onboarding",  
  diet: "omnivore",  
  title: {
    en: "The complexity of our food choices",
    es: "La complejidad de nuestras elecciones alimentarias",
    hu: "Az ételválasztásunk összetettsége"
  },
  lesson: {
    en: `
    <p>Welcome back — day two!</p>

    <p>As you continue, you’ll start discovering more about how your food choices connect to the world around you.</p>

    <p>Two areas come up often: <strong>environment</strong> and <strong>health</strong>.</p>

    <p>Many studies suggest that more plant-based meals can reduce environmental impact — and can support long-term health when done well.</p>

    <p>We’ll take a closer look at these topics.</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día dos!</p>

    <p>A medida que continúas, empezarás a descubrir más sobre cómo tus elecciones alimentarias se conectan con el mundo que te rodea.</p>

    <p>Dos temas aparecen con frecuencia: <strong>el medio ambiente</strong> y <strong>la salud</strong>.</p>

    <p>Muchos estudios sugieren que una mayor cantidad de comidas basadas en plantas puede reducir el impacto ambiental — y apoyar una salud a largo plazo cuando se hace correctamente.</p>

    <p>Exploraremos estos temas más a fondo.</p>
    `,
    hu: `
    <p>Üdv újra — második nap!</p>

    <p>Ahogy folytatod, egyre többet fogsz felfedezni arról, hogyan kapcsolódnak az ételválasztásaid a körülötted lévő világhoz.</p>

    <p>Két téma gyakran előkerül: <strong>a környezet</strong> és <strong>az egészség</strong>.</p>

    <p>Sok kutatás szerint a több növényi alapú étkezés csökkentheti a környezeti terhelést — és megfelelően összeállítva hosszú távon az egészséget is támogathatja.</p>

    <p>Ezeket a témákat fogjuk jobban megvizsgálni.</p>
    `
  }
},
...
5002: {  
  ...
  diet: "omnivore",  
  title: {
    en: "More than just food",
    es: "Más que comida",
    hu: "Több mint étel"
  },
  lesson: {
    en: `
    <p>Welcome back — day three!</p>

    <p>By now, you might be starting to notice something: food is more than just what’s on your plate.</p>

    <p>It begins with production, continues through processing and transport, and reaches a moment of choice when you sit down to eat.</p>

    <p>And it doesn’t stop there — your body responds to what you eat right away. Over time, these small moments can turn into habits that shape your health, your energy, and how you feel each day.</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día tres!</p>

    <p>Puede que ya estés empezando a notar algo: la comida es más que lo que hay en tu plato.</p>

    <p>Comienza con la producción, continúa con el procesamiento y el transporte, y llega a un momento de decisión cuando te sientas a comer.</p>

    <p>Y no termina ahí — tu cuerpo responde a lo que comes de inmediato. Con el tiempo, estos pequeños momentos pueden convertirse en hábitos que influyen en tu salud, tu energía y cómo te sientes cada día.</p>
    `,
    hu: `
    <p>Üdv újra — harmadik nap!</p>

    <p>Lehet, hogy már kezded észrevenni: az étel több annál, mint ami a tányérodon van.</p>

    <p>A termeléssel kezdődik, majd feldolgozáson és szállításon keresztül jut el a döntés pillanatáig, amikor leülsz enni.</p>

    <p>És itt még nincs vége — a tested azonnal reagál arra, amit eszel. Idővel ezek a kis pillanatok szokásokká válhatnak, amelyek hatással vannak az egészségedre, az energiádra és arra, hogyan érzed magad minden nap.</p>
    `
  }
},
 ...
 5003: {  
  ...
  diet: "vegetarian",  
  title: {
    en: "Beyond where we already are",
    es: "Más allá de donde ya estamos",
    hu: "Túl azon, ahol már vagyunk"
  },
  lesson: {
    en: `
    <p>Welcome back — day two!</p>

    <p>As vegetarians, we’ve already made an important step by reducing direct animal consumption — and that already has a real impact 🌱</p>

    <p>But there is still more depth we can explore together.</p>

    <p>This journey is about understanding how we can continue to grow, reduce harm even further, and inspire positive change around us.</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día dos!</p>

    <p>Como vegetarianos, ya hemos dado un paso importante al reducir el consumo directo de animales — y eso ya tiene un impacto real 🌱</p>

    <p>Pero aún hay más profundidad que podemos explorar juntos.</p>

    <p>Este camino trata de entender cómo podemos seguir creciendo, reducir aún más el daño e inspirar cambios positivos a nuestro alrededor.</p>
    `,
    hu: `
    <p>Üdv újra — második nap!</p>

    <p>Vegetáriánusként már megtettünk egy fontos lépést azzal, hogy csökkentettük az állatok közvetlen fogyasztását — és ennek már valódi hatása van 🌱</p>

    <p>De még van mélyebb réteg, amit együtt felfedezhetünk.</p>

    <p>Ez az út arról szól, hogyan tudunk tovább fejlődni, még több kárt csökkenteni, és pozitív változást inspirálni a környezetünkben.</p>
    `
  }
},
 ...
 5004: {  
  ...
  diet: "vegetarian",  
  title: {
    en: "A wider perspective",
    es: "Una perspectiva más amplia",
    hu: "Egy tágabb nézőpont"
  },
  lesson: {
    en: `
    <p>Welcome back — day three!</p>

    <p>When we move away from eating meat, a new perspective often opens up.</p>

    <p>We start to think more broadly about our relationship with animals — not only in terms of food, but also how we live alongside them.</p>

    <p>Even without causing direct harm, there are still many ways our choices can shape their world — and ours.</p>

    <p>This stage is about reflection, not perfection 🌱</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día tres!</p>

    <p>Cuando dejamos de comer carne, a menudo se abre una nueva perspectiva.</p>

    <p>Empezamos a pensar de forma más amplia sobre nuestra relación con los animales — no solo en términos de alimentación, sino también en cómo convivimos con ellos.</p>

    <p>Incluso sin causar daño directo, nuestras decisiones aún pueden influir en su mundo — y en el nuestro.</p>

    <p>Esta etapa trata de reflexión, no de perfección 🌱</p>
    `,
    hu: `
    <p>Üdv újra — harmadik nap!</p>

    <p>Amikor nem fogyasztunk húst, gyakran egy új nézőpont nyílik meg.</p>

    <p>Elkezdünk tágabban gondolkodni az állatokkal való kapcsolatunkról — nem csak ételként, hanem mint együtt élő lényekről.</p>

    <p>Még közvetlen kár okozása nélkül is számos módja van annak, hogy döntéseink hatással legyenek az ő világukra — és a sajátunkra is.</p>

    <p>Ez a szakasz nem a tökéletességről szól, hanem a gondolkodásról 🌱</p>
    `
  }
},
...
5005: {  
  ...
  diet: "pescatarian",  
  title: {
    en: "Beyond what we already know",
    es: "Más allá de lo que ya conocemos",
    hu: "Túl azon, amit már tudunk"
  },
  lesson: {
    en: `
    <p>Welcome back — day two!</p>

    <p>As pescatarians, we’ve already made a conscious shift in our food choices — and that already matters!</p>

    <p>Fish often feel like a simpler choice, but the reality behind seafood is more complex than it first appears.</p>

    <p>There is a whole system connected to oceans, ecosystems, and the way we source food from them.</p>

    <p>Our journey is about gently opening that perspective, and understanding more.</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día dos!</p>

    <p>Como pescetarianos, ya hemos hecho un cambio consciente en nuestras elecciones alimentarias — y eso ya importa!</p>

    <p>El pescado suele parecer una opción más simple, pero la realidad detrás del mar es más compleja de lo que parece a primera vista.</p>

    <p>Existe todo un sistema relacionado con los océanos, los ecosistemas y la forma en que obtenemos alimentos de ellos.</p>

    <p>Nuestra experiencia se trata de abrir esa perspectiva con calma, y de entender más.</p>
    `,
    hu: `
    <p>Üdv újra — második nap!</p>

    <p>Pescatariánusként már tudatos változtatást tettünk az étkezésünkben — és ez már önmagában is számít!</p>

    <p>A hal gyakran egyszerűbb választásnak tűnik, de a tenger mögötti valóság sokkal összetettebb, mint elsőre gondolnánk.</p>

    <p>Az óceánok, az ökoszisztémák és az élelmiszer-nyerés folyamatai mind egy nagyobb rendszer részei.</p>

    <p>Ma egy új nézőpontot nyitunk meg — a jobb megértés céljából.</p>
    `
  }
},
 ...
 5006: {  
  ...
  diet: "pescatarian",  
  title: {
    en: "What connects everything",
    es: "Lo que conecta todo",
    hu: "Ami mindent összeköt"
  },
  lesson: {
    en: `
    <p>Welcome back — day three!</p>

    <p>Dolphins, sea turtles, coral reefs, and countless fish species all share oceans, each playing a role in a delicate balance.</p>

    <p>Scientists are still studying many aspects of marine life — including how fish experience pain and their environment.</p>

    <p>When one part of an ecosystem changes, others can be affected in ways that are not always immediately visible.</p>

    <p>This is where awareness starts to become perspective 🌱</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día tres!</p>

    <p>Delfines, tortugas marinas, arrecifes de coral y numerosas especies de peces comparten los océanos, cada uno con un papel en un equilibrio delicado.</p>

    <p>Los científicos aún estudian muchos aspectos de la vida marina — incluyendo cómo los peces experimentan dolor y su entorno.</p>

    <p>Cuando una parte del ecosistema cambia, otras pueden verse afectadas de formas que no siempre son visibles de inmediato.</p>

    <p>Aquí es donde la conciencia empieza a convertirse en perspectiva 🌱</p>
    `,
    hu: `
    <p>Üdv újra — harmadik nap!</p>

    <p>Delfinek, tengeri teknősök, korallzátonyok és számtalan halfaj osztozik az óceánokon, mindegyikük szerepet játszik egy érzékeny egyensúlyban.</p>

    <p>A tudósok még mindig sok részletet kutatnak a tengeri élővilágról — beleértve azt is, hogyan érzékelik a halak a fájdalmat és hogyan élik meg környezetüket.</p>

    <p>Ha egy ökoszisztéma egyik része megváltozik, más részek is hatással lehetnek egymásra — gyakran nem azonnal látható módon.</p>

    <p>Itt kezd a tudatosság nézőponttá válni 🌱</p>
    `
  },
},
 ...
 5007: {  
  ...
  diet: "flexitarian",  
  title: {
    en: "Real life choices",
    es: "Decisiones en la vida real",
    hu: "Valós élethelyzetek"
  },
  lesson: {
    en: `
<p>Welcome back — day two!</p>

<p>Real life doesn’t always follow our intentions when it comes to food.</p>

<p>Social situations, family meals, travel, or convenience can all shape what we end up eating.</p>

<p>Sometimes it makes sense to stay flexible — even when we usually try to eat differently.</p>

<p>This is part of learning how your choices fit into everyday life, not just ideal situations.</p>
    `,
    es: `
<p>Bienvenido de nuevo — día dos!</p>

<p>La vida real no siempre sigue nuestras intenciones cuando se trata de la comida.</p>

<p>Las situaciones sociales, las comidas familiares, los viajes o la comodidad pueden influir en lo que terminamos comiendo.</p>

<p>A veces tiene sentido ser flexible — incluso cuando normalmente intentamos comer de otra manera.</p>

<p>Esto forma parte de aprender cómo nuestras decisiones encajan en la vida cotidiana, no solo en situaciones ideales.</p>
    `,
    hu: `
<p>Üdv újra — második nap!</p>

<p>A való élet nem mindig követi az elhatározásainkat, amikor étkezésről van szó.</p>

<p>A társas helyzetek, családi étkezések, utazás vagy a kényelem mind befolyásolhatják, mit eszünk végül.</p>

<p>Néha van értelme rugalmasnak maradni — még akkor is, ha általában másképp próbálunk étkezni.</p>

<p>Ez arról szól, hogyan illeszkednek a döntéseink a mindennapi életbe, nem csak az ideális helyzetekbe.</p>
    `
  }
},
...
<p>After noticing how external situations influence our food choices, the next step is looking inward.</p>

<p>At some point, every person starts to define their own balance — what feels right, and where their personal boundaries are.</p>

<p>These decisions are not only about food, but about values, identity, and consistency over time.</p>

<p>This stage is about understanding where you stand — for yourself.</p>
    `,
    es: `
<p>Bienvenido de nuevo — día tres!</p>

<p>Después de notar cómo las situaciones externas influyen en nuestras decisiones alimentarias, el siguiente paso es mirar hacia dentro.</p>

<p>Llega un momento en el que cada persona empieza a definir su propio equilibrio — lo que le parece correcto y cuáles son sus límites personales.</p>

<p>Estas decisiones no solo tratan de la comida, sino también de valores, identidad y coherencia a lo largo del tiempo.</p>

<p>Esta etapa trata de entender dónde te encuentras — para ti mismo.</p>
    `,
    hu: `
<p>Üdv újra — harmadik nap!</p>

<p>Miután láttuk, hogyan befolyásolják a külső helyzetek az étkezési döntéseinket, a következő lépés befelé fordulni.</p>

<p>Eljön egy pont, amikor mindenki elkezdi meghatározni a saját egyensúlyát — mi az, ami számára helyes, és hol vannak a személyes határai.</p>

<p>Ezek a döntések nem csak az ételről szólnak, hanem értékekről, identitásról és hosszú távú következetességről is.</p>

<p>Ez a szakasz arról szól, hogy megértsd önmagad.</p>
    `
  }
},
...
5009: {  
  ...
  lesson: {
    ...
    <p>When we begin to recognize our values, question the system around us, and notice the gap between what we believe and what we do — change often starts to take shape.</p>

    <p>But real change rarely happens all at once.</p>

    <p>Almost no one becomes fully vegan overnight. It is usually a gradual process of learning, adjusting habits, and discovering new perspectives along the way.</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día dos!</p>

    <p>Cuando empezamos a reconocer nuestros valores, a cuestionar el sistema que nos rodea y a notar la diferencia entre lo que creemos y lo que hacemos — el cambio empieza a tomar forma.</p>

    <p>Pero el cambio real rara vez ocurre de una sola vez.</p>

    <p>Casi nadie se vuelve completamente vegano de la noche a la mañana. Normalmente es un proceso gradual de aprendizaje, adaptación de hábitos y descubrimiento de nuevas perspectivas.</p>
    `,
    hu: `
    <p>Üdv újra — második nap!</p>

    <p>Amikor elkezdjük felismerni az értékeinket, megkérdőjelezni a körülöttünk lévő rendszert, és észrevenni a különbséget aközött, amit hiszünk és amit teszünk — a változás elkezd formálódni.</p>

    <p>De a valódi változás ritkán történik egyszerre.</p>

    <p>Szinte senki nem válik egyik napról a másikra vegánná. Ez általában egy fokozatos folyamat: tanulás, szokások alakítása és új nézőpontok felfedezése.</p>
    `
  }
},
...
5010: {  
  ...
  diet: "intransition",  
  title: {
    en: "Staying on your path",
    es: "Manteniéndote en tu camino",
    hu: "A saját utadon maradni"
  },
  lesson: {
    en: `
    <p>Welcome back — day three!</p>

    <p>As you move forward, you may already notice real-world challenges — social pressure, limited options, or moments where it feels easier to give up.</p>

    <p>This is part of the process, not a sign that something is wrong.</p>

    <p>Knowing what to eat, where to find it, how to balance nutrition, and how to stay aligned with your values can take time to build.</p>

    <p>We will explore strategies, inspiring stories, and ways to connect with like-minded people — so you don’t feel alone on this journey 🌱</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día tres!</p>

    <p>A medida que avanzas, es posible que ya notes desafíos reales — presión social, opciones limitadas o momentos en los que parece más fácil rendirse.</p>

    <p>Esto forma parte del proceso, no una señal de que algo está mal.</p>

    <p>Saber qué comer, dónde encontrarlo, cómo equilibrar la nutrición y cómo mantenerse alineado con tus valores lleva tiempo.</p>

    <p>Exploraremos estrategias, historias inspiradoras y formas de conectar con personas afines — para que no te sientas solo en este camino 🌱</p>
    `,
    hu: `
    <p>Üdv újra — harmadik nap!</p>

    <p>Ahogy haladsz előre, már most is tapasztalhatsz valós kihívásokat — társadalmi nyomást, korlátozott lehetőségeket vagy olyan pillanatokat, amikor könnyebb lenne feladni.</p>

    <p>Ez a folyamat része, nem annak jele, hogy valami nincs rendben.</p>

    <p>Tudni, mit érdemes enni, hol lehet megtalálni, hogyan érdemes kiegyensúlyozni a táplálkozást és hogyan maradj összhangban az értékeiddel — mind időt igényel.</p>

    <p>Felfedezünk majd stratégiákat, inspiráló történeteket és lehetőségeket arra, hogy hasonló gondolkodású emberekkel kapcsolódj — hogy ne érezd magad egyedül ezen az úton 🌱</p>
    `
  }
},
 ...
 5011: {  
  ...
  diet: "vegan",  
  title: {
    en: "Strength in difference",
    es: "Fuerza en la diferencia",
    hu: "Erő a különbözőségben"
  },
  lesson: {
    en: `
    <p>Welcome back — day two!</p>

    <p>As vegans, we often face a unique challenge — simply being different from what is considered the norm in society.</p>

    <p>This can sometimes feel difficult: navigating conversations with family and friends, feeling misunderstood, or dealing with social pressure.</p>

    <p>It is completely normal to feel tired at times — you are not alone in this experience.</p>

    <p>In this space, we will focus on inspiration, connection, and building strength through community — so you can continue your path with clarity and confidence 🌱</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día dos!</p>

    <p>Como veganos, a menudo enfrentamos un desafío único — simplemente ser diferentes de lo que se considera la norma en la sociedad.</p>

    <p>Esto a veces puede ser difícil: conversaciones con familia y amigos, sentirnos incomprendidos o lidiar con la presión social.</p>

    <p>Es completamente normal sentirse cansado a veces — no estás solo en esta experiencia.</p>

    <p>En este espacio nos centraremos en la inspiración, la conexión y la fuerza de la comunidad — para que puedas continuar tu camino con claridad y confianza 🌱</p>
    `,
    hu: `
    <p>Üdv újra — második nap!</p>

    <p>Vegánként gyakran egy különleges kihívással találkozunk — azzal, hogy egyszerűen különbözünk a társadalmi normáktól.</p>

    <p>Ez néha nehéz lehet: beszélgetések a családdal és barátokkal, félreértettség érzése vagy társadalmi nyomás kezelése.</p>

    <p>Teljesen természetes, ha néha fáradtnak érzed magad — ebben nem vagy egyedül.</p>

    <p>Ebben a térben az inspirációra, kapcsolódásra és a közösség erejére fókuszálunk — hogy tisztán és magabiztosan tudj haladni az utadon 🌱</p>
    `
  },
  source: ""
},
...
5012: {  
  ...
  title: {
    en: "Staying grounded",
    es: "Mantenerse firme",
    hu: "Stabilitás és önmagunk megtartása"
  },
  lesson: {
    en: `
    <p>Welcome back — day three!</p>

    <p>As you care deeply about animals and your values, it is just as important to take care of yourself in the process.</p>

    <p>One of the strongest supports is surrounding yourself with people who share similar values and understanding.</p>

    <p>It also helps to better understand human behavior — why people think differently, and how common arguments you may hear are often based on misunderstanding or incomplete information.</p>

    <p>In this stage, we focus on knowledge, resilience, and connection — so you can stay grounded in your path 🌱</p>
    `,
    es: `
    <p>Bienvenido de nuevo — día tres!</p>

    <p>Como te importan los animales y tus valores, es igual de importante cuidarte a ti mismo en el proceso.</p>

    <p>Uno de los mayores apoyos es rodearte de personas que compartan valores y comprensión similares.</p>

    <p>También ayuda comprender mejor el comportamiento humano — por qué las personas piensan diferente y cómo muchos argumentos que escuchas suelen basarse en malentendidos o información incompleta.</p>

    <p>En esta etapa nos centramos en el conocimiento, la resiliencia y la conexión — para que puedas mantenerte firme en tu camino 🌱</p>
    `,
    hu: `
    <p>Üdv újra — harmadik nap!</p>

    <p>Mivel az állatok és az értékeid fontosak számodra, ugyanilyen fontos, hogy közben önmagadra is vigyázz.</p>

    <p>Az egyik legerősebb támasz, ha olyan emberek vesznek körül, akik hasonló értékeket képviselnek és megértenek téged.</p>

    <p>Segít az is, ha jobban megértjük az emberi viselkedést — miért gondolkodnak másként az emberek, és hogy sok érv, amivel találkozol, gyakran félreértésből vagy hiányos információból ered.</p>

    <p>Ebben a szakaszban a tudásra, a rugalmasságra és a kapcsolódásra fókuszálunk — hogy stabilan tudj haladni az utadon 🌱</p>
    `
  }
}
...
// ===========================
// ONBOARDING EXTENSION POOL
// (Lesson 5–6 per diet)
// ===========================

export const onboardingSecondLessonPool = {
  ...
  diet: "omnivore",  
  title: {
    en: "Is meat necessary?",
    es: "¿Es necesario comer carne?",
    hu: "Szükséges húst enni?"
  },
  lesson: {
    en: `
    <p>A question: is eating meat necessary for a healthy life?</p>

    <p>Many people grow up believing it is — for protein, strength, or tradition.</p>

    <p>At the same time, major health organizations agree that well-planned plant-based diets can provide all the nutrients the body needs.</p>

    <p>This suggests that, for many people, eating meat is more of a choice than a strict necessity.</p>
    `,
    es: `
<p>Una pregunta: ¿es necesario comer carne para tener una vida saludable?</p>

<p>Muchas personas crecen creyendo que sí — por la proteína, la fuerza o la tradición.</p>

<p>Al mismo tiempo, las principales organizaciones de salud coinciden en que una alimentación basada en plantas, bien planificada, puede aportar todos los nutrientes que el cuerpo necesita.</p>

<p>Esto sugiere que, para muchas personas, comer carne es más una elección que una necesidad estricta.</p>
`,
hu: `
<p>Egy kérdés: szükséges húst enni az egészséges élethez?</p>

<p>Sokan úgy nőnek fel, hogy ezt természetesnek tartják — a fehérje, az erő vagy a hagyományok miatt.</p>

<p>Ugyanakkor a vezető egészségügyi szervezetek egyetértenek abban, hogy a jól megtervezett növényi alapú étrend minden szükséges tápanyagot biztosíthat a szervezet számára.</p>

<p>Ez arra utal, hogy sok ember számára a húsfogyasztás inkább választás, mint szigorú szükséglet.</p>
`
  },
    source: "https://v7.viva.org.uk/faqs/humans-are-omnivores-so-were-supposed-to-eat-meat/"
  },
  ...
  6002: {
    goal: "Onboarding",
    title: {
    en: "A complex food system",
    es: "Un sistema alimentario complejo",
    hu: "Egy összetett élelmiszer-rendszer"
  },
  lesson: {
    en: `
<p>As we look deeper, food systems reveal an interesting complexity.</p>

<p>Today, a large share of global agricultural land — around <strong>76%</strong> — is used for livestock and to grow feed for animals.</p>

<p>This means that many crops are not eaten directly by people, but are first used to feed animals, which then provide a smaller amount — around <strong>17%</strong> of global calories — in return.</p>

<p>This has broader effects, including impacts on land use, deforestation, biodiversity, and access to food around the world.</p>
`,es: `
<p>A medida que profundizamos, los sistemas alimentarios revelan una interesante complejidad.</p>

<p>Hoy en día, una gran parte de la tierra agrícola mundial — alrededor del <strong>76%</strong> — se utiliza para la ganadería y para producir alimento para los animales.</p>

<p>Esto significa que muchos cultivos no son consumidos directamente por las personas, sino que primero se destinan a alimentar animales, que luego aportan una cantidad menor — alrededor del <strong>17%</strong> de las calorías globales — a cambio.</p>

<p>Esto tiene efectos más amplios, incluyendo impactos en el uso de la tierra, la deforestación, la biodiversidad y el acceso a los alimentos en todo el mundo.</p>
`,
hu: `
<p>Ahogy mélyebbre tekintünk, az élelmiszer-rendszerek egy érdekes összetettséget tárnak fel.</p>

<p>Napjainkban a mezőgazdasági területek nagy része — körülbelül <strong>76%</strong> — állattartásra és takarmánytermelésre van használva.</p>

<p>Ez azt jelenti, hogy sok növényt nem közvetlenül az emberek fogyasztanak el, hanem először állatok etetésére használják fel, amelyek ezután kisebb mennyiséget — körülbelül a globális kalóriák <strong>17%</strong>-át — adják vissza.</p>

<p>Ennek szélesebb hatásai is vannak, többek között a földhasználatra, az erdőirtásra, a biodiverzitásra és az élelmiszerekhez való hozzáférésre világszerte.</p>
`
  },
  ...
  lesson: {
  en: `
    <p>Most vegetarians begin their journey for a reason. It often comes from a simple realization: animals are not just products — they are individuals, capable of feeling and experiencing their lives.</p>

    <p>A natural question can arise here.</p>

    <p>If they are not products, how do we feel about practices such as breeding and selling them, or using them for fur, leather, or entertainment in places like circuses or zoos?</p>
  `,
  es: `
    <p>La mayoría de las personas vegetarianas comienzan su camino por una razón. A menudo surge de una idea simple: los animales no son solo productos — son individuos capaces de sentir y experimentar su vida.</p>

    <p>Aquí puede surgir una pregunta natural.</p>

    <p>Si no son productos, ¿cómo nos sentimos respecto a prácticas como su cría y venta, o su uso para obtener pieles, cuero, o como entretenimiento en lugares como circos o zoológicos?</p>
  `,
  hu: `
    <p>A legtöbb vegetáriánus valamilyen okból indul el ezen az úton. Ez gyakran egy egyszerű felismerésből fakad: az állatok nem csupán termékek — egyedek, akik képesek érezni és megélni az életüket.</p>

    <p>Itt egy természetes kérdés merülhet fel.</p>

    <p>Ha nem termékek, hogyan viszonyulunk az olyan gyakorlatokhoz, mint a tenyésztésük és eladásuk, vagy a szőrme- és bőripar, illetve az állatok felhasználása szórakoztatásra, például cirkuszokban vagy állatkertekben?</p>
  `
}
  },
  ...
  diet: "vegetarian",
  title: {
    en: "Dairy and using animals",
    es: "Los lácteos y el uso de los animales",
    hu: "Tejtermékek és az állatok használata"
  },
  lesson: {
    en: `
    <p>Building on yesterday’s idea — that animals are not just products, but individuals — we can look at another major topic: the modern dairy industry.</p>

    <p>Dairy production is closely connected to animal farming systems, and it also raises further ethical questions.</p>

    <p>This is where our next topic begins — exploring how dairy fits into the bigger picture of food and animal use</p>
    `,
    es: `
    <p>Partiendo de la idea de ayer — que los animales no son solo productos, sino individuos — podemos mirar otro tema importante: la industria láctea moderna.</p>

    <p>La producción de lácteos está estrechamente relacionada con los sistemas de ganadería, y también plantea nuevas cuestiones éticas.</p>

    <p>Aquí comienza nuestro próximo tema — explorar cómo los lácteos encajan en el panorama más amplio de la alimentación y el uso de animales</p>
    `,
    hu: `
    <p>Folytatva a tegnapi gondolatot — hogy az állatok nem csupán termékek — egy újabb fontos témára térhetünk át: a modern tejiparra.</p>

    <p>A tejtermelés szorosan kapcsolódik az állattartási rendszerekhez, és további etikai kérdéseket is felvet.</p>

    <p>Itt kezdődik a következő témánk — annak feltárása, hogyan illeszkedik a tejtermelés az élelmiszer és az állathasználat tágabb képébe</p>
    `
  }
},
  ...
  diet: "pescatarian",
  title: {
    en: "Values and consistency",
    es: "Valores y coherencia",
    hu: "Értékek és következetesség"
  },
  lesson: {
  en: `
    <p>Many people choose a pescatarian path for similar reasons to vegetarianism — often guided by health, environmental, or ethical reflection.</p>

    <p>If we see animals as individuals, not as products, a natural question can arise.</p>

    <p>What about practices such as breeding and selling them, using them in circuses or zoos, using their fur or skin, or even their role in dairy farming?</p>
  `,
  es: `
    <p>Muchas personas eligen un estilo pescetariano por razones similares al vegetarianismo — a menudo guiados por la salud, el medio ambiente o la reflexión ética.</p>

    <p>Si vemos a los animales como individuos, y no como productos, puede surgir una pregunta natural.</p>

    <p>¿Qué ocurre con prácticas como su cría y venta, su uso en circos o zoológicos, el uso de su piel o cuero, o incluso su papel en la industria láctea?</p>
  `,
  hu: `
    <p>Sokan választják a pescatariánus étrendet hasonló okokból, mint a vegetáriánust — gyakran egészség, környezet vagy etikai megfontolások miatt.</p>

    <p>Ha az állatokat egyedekként látjuk, nem pedig termékekként, egy természetes kérdés merülhet fel.</p>

    <p>Mi a helyzet az olyan gyakorlatokkal, mint a tenyésztésük és eladásuk, cirkuszokban vagy állatkertekben való használatuk, a bundájuk vagy bőrük felhasználása, vagy akár a tejiparban betöltött szerepük?</p>
  `
}
},
  ...
  6006: {
    ...
    diet: "pescatarian",
    title: {
  en: "Do fish feel pain?",
  es: "¿Los peces sienten dolor?",
  hu: "A halak éreznek fájdalmat?"
},
    lesson: {
  en: `
    <p>We often feel less empathy toward fish — possibly because it is harder to recognize or imagine their experience.</p>

    <p>But how can we know what they feel?</p>

    <p>Scientific studies suggest that many fish species show responses to pain, stress, and learning behaviors, indicating a more complex inner life than once assumed.</p>

    <p>At the same time, one of the most significant factors affecting marine life is the scale and impact of the fishing industry itself.</p>
  `,
  es: `
    <p>A menudo sentimos menos empatía hacia los peces — posiblemente porque es más difícil reconocer o imaginar su experiencia.</p>

    <p>Pero, ¿cómo podemos saber lo que sienten?</p>

    <p>Estudios científicos sugieren que muchas especies de peces muestran respuestas al dolor, al estrés y comportamientos de aprendizaje, lo que indica una vida interna más compleja de lo que se creía antes.</p>

    <p>Al mismo tiempo, uno de los factores más importantes que afectan a la vida marina es la escala y el impacto de la industria pesquera.</p>
  `,
  hu: `
    <p>Gyakran kevesebb empátiát érzünk a halak iránt — valószínűleg azért, mert nehezebb elképzelni vagy felismerni az élményeiket.</p>

    <p>De hogyan tudhatjuk, mit éreznek?</p>

    <p>Tudományos kutatások szerint számos halfaj mutat fájdalomra, stresszre és tanulásra adott válaszokat, ami arra utal, hogy összetettebb belső életük van, mint korábban gondolták.</p>

    <p>Ugyanakkor a tengeri élővilágot egyik legnagyobb mértékben a halászati ipar mérete és hatása befolyásolja.</p>
  `
},
    source: "https://sentientmedia.org/do-fish-feel-pain/, https://www.worldwildlife.org/resources/explainers/ghost-fishing-gear/"
  },
  ...
  diet: "flexitarian",
  title: {
    en: "Reducing waste in real life",
    es: "Reducir el desperdicio en la vida real",
    hu: "Ételpazarlás csökkentése a való életben"
  },
  lesson: {
    en: `
<p>In real life, food choices are not always about intention alone — they are also shaped by what already exists around us.</p>

<p>One common example is food waste.</p>

<p>Sometimes, meat or dairy products might otherwise go unused and end up being thrown away. In these situations, some people choose to consume them as a way of reducing waste, without increasing demand for production.</p>

<p>This is one of many ways people try to balance practicality with their personal values.</p>
    `,
    es: `
<p>En la vida real, las decisiones alimentarias no siempre dependen solo de la intención — también están influenciadas por lo que ya existe a nuestro alrededor.</p>

<p>Un ejemplo común es el desperdicio de alimentos.</p>

<p>A veces, los productos de carne o lácteos podrían no usarse y terminar siendo desechados. En estas situaciones, algunas personas eligen consumirlos como una forma de reducir el desperdicio, sin aumentar la demanda de producción.</p>

<p>Esta es una de las muchas formas en que las personas intentan equilibrar la practicidad con sus valores personales.</p>
    `,
    hu: `
<p>A való életben az étkezési döntéseket nem csak a szándékok határozzák meg — hanem az is, ami már eleve adott körülöttünk.</p>

<p>Gyakori példa az élelmiszerpazarlás kérdése.</p>

<p>Előfordulhat, hogy hús- vagy tejtermékek egyébként kidobásra kerülnének. Ilyen helyzetekben vannak akik úgy döntenek, hogy elfogyasztják őket, ezzel csökkentve a pazarlást, anélkül hogy növelnék a termelés iránti keresletet.</p>

<p>Ez csak egy példa arra, hogyan próbálják az emberek egyensúlyba hozni a gyakorlati szempontokat és az értékeiket.</p>
    `
  }
},
  ...
  diet: "flexitarian",
  title: {
    en: "Boundaries and consistency",
    es: "Límites y coherencia",
    hu: "Határok és következetesség"
  },
  lesson: {
    en: `
<p>Boundaries are one of the most practical ways we express our values in real life.</p>

<p>In social situations — like family meals or shared events — your choices can gently influence what others expect and prepare for you over time.</p>

<p>At first, this might feel uncomfortable, but consistency often brings clarity. People adjust, habits shift, and new patterns form around you.</p>

<p>In many cases, boundaries don’t create conflict — they simply help your choices become respected 🌱</p>
    `,
    es: `
<p>Los límites son una de las formas más prácticas de expresar nuestros valores en la vida real.</p>

<p>En situaciones sociales — como comidas familiares o eventos compartidos — nuestras decisiones pueden influir poco a poco en lo que los demás esperan y preparan para nosotros.</p>

<p>Al principio puede resultar incómodo, pero la coherencia suele traer claridad. Las personas se adaptan, los hábitos cambian y se forman nuevas dinámicas a tu alrededor.</p>

<p>En muchos casos, los límites no generan conflicto — simplemente ayudan a que tus decisiones sean respetadas 🌱</p>
    `,
    hu: `
<p>A határok az egyik leggyakorlatibb módjai annak, hogy az értékeinket a való életben is kifejezzük.</p>

<p>Társas helyzetekben — például családi étkezéseknél vagy közös eseményeken — a döntéseink idővel befolyásolhatják, mit várnak el és mit készítenek számunkra mások.</p>

<p>Ez eleinte kényelmetlen lehet, de a következetesség meggyőző. Az emberek alkalmazkodnak, a szokások változnak, és új minták alakulnak ki körülöttünk.</p>

<p>Sok esetben a határok nem konfliktust hoznak — hanem segítenek, hogy a döntéseink tiszteletet kapjanak 🌱</p>
    `
  }
},
  ...
  diet: "intransition",
  title: {
    en: "Recognizing your direction",
    es: "Reconociendo tu camino",
    hu: "Az irányod felismerése"
  },
  lesson: {
  en: `
    <p>Since you have already started moving in a direction that matters to you, it can be helpful to pause for a moment.</p>

    <p>What do you truly want for yourself?</p>

    <p>Do you want to be kind enough to yourself — to give yourself what you truly want — even if it takes time and effort?</p>

    <p>And can you feel proud of that process?</p>

    <p>Because you can be proud of it — and we’ll see why 🌱</p>
  `,
  es: `
    <p>Ya que has comenzado a moverte en una dirección que es importante para ti, puede ser útil hacer una pausa por un momento.</p>

    <p>¿Qué es lo que realmente quieres para ti?</p>

    <p>¿Quieres ser lo suficientemente amable contigo mismo — como para darte lo que realmente quieres — aunque requiera tiempo y esfuerzo?</p>

    <p>¿Y puedes sentirte orgulloso de ese proceso?</p>

    <p>Porque puedes estar orgulloso de ello — y veremos por qué 🌱</p>
  `,
  hu: `
    <p>Mivel már elindultál egy számodra fontos irányba, érdemes lehet egy pillanatra megállni.</p>

    <p>Mit szeretnél valójában magadnak?</p>

    <p>Szeretnél elég kedves lenni magadhoz — hogy megadd magadnak azt, amire valóban vágysz — még ha ez időt és energiát is igényel?</p>

    <p>És tudsz-e büszke lenni erre?</p>

    <p>Mert büszke lehetsz rá — és meg fogjuk nézni, miért 🌱</p>
  `
}
},
  ...
  diet: "intransition",
  title: {
    en: "What boundaries really are",
    es: "Qué son realmente los límites",
    hu: "Mik is valójában a határok"
  },
  lesson: {
    en: `
<p>When we talk about boundaries, we are not talking about rules or strict restrictions.</p>

<p>We are talking about simple decisions in real moments.</p>

<p>For example, saying “no” once to something you don’t want to eat is already a boundary.</p>

<p>And that single moment can create change for the next time 🌱</p>
    `,
    es: `
<p>Cuando hablamos de límites, no nos referimos a reglas o restricciones estrictas.</p>

<p>Hablamos de decisiones simples en momentos reales.</p>

<p>Por ejemplo, decir “no” una vez a algo que no quieres comer ya es un límite.</p>

<p>Y ese único momento puede crear un cambio para la próxima vez 🌱</p>
    `,
    hu: `
<p>Amikor a határokról beszélünk, nem szabályokra vagy szigorú korlátozásokra gondolunk.</p>

<p>Egyszerű, valós helyzetekben hozott döntésekről van szó.</p>

<p>Például ha egyszer nemet mondasz valamire, amit nem szeretnél megenni, az már egy határ.</p>

<p>És ez az egy pillanat változást hozhat a következő alkalomra 🌱</p>
    `
  }
},
  ...
  diet: "vegan",
  title: {
    en: "How perception shapes acceptance",
    es: "Cómo la percepción influye en la aceptación",
    hu: "Hogyan befolyásolja a megítélés az elfogadást"
  },
  lesson: {
    en: `
    <p>One of the simplest human reactions is this: if people do not like someone or something, they are more likely to reject the message that comes with it.</p>

    <p>This means ideas are not always judged only by their content — but also by how the messenger or the topic is perceived.</p>

    <p>This can also affect how veganism is received, especially when it is associated with negative or simplified images.</p>

    <p>Understanding this can help us communicate more effectively and with more awareness</p>
  `,
    es: `
    <p>Una de las reacciones humanas más simples es esta: si a las personas no les gusta alguien o algo, es más probable que rechacen el mensaje que viene con ello.</p>

    <p>Esto significa que las ideas no siempre se juzgan solo por su contenido — sino también por cómo se percibe al mensajero o el tema.</p>

    <p>Esto también puede afectar cómo se recibe el veganismo, especialmente cuando se asocia con imágenes negativas o simplificadas.</p>

    <p>Entender esto puede ayudarnos a comunicarnos de forma más efectiva y consciente</p>
  `,
    hu: `
    <p>Az egyik legegyszerűbb emberi reakció a következő: ha valaki nem szimpatikus, az emberek nagyobb eséllyel utasítják el az üzenetét is.</p>

    <p>Ez azt jelenti, hogy az ötleteket nem csak a tartalmuk alapján ítéljük meg — hanem az alapján is, hogyan látjuk az üzenet közvetítőjét vagy magát a témát.</p>

    <p>Ez a veganizmus megítélésére is hatással lehet, különösen ha negatív vagy leegyszerűsített képek kapcsolódnak hozzá.</p>

    <p>Ennek megértése segíthet hatékonyabban és tudatosabban kommunikálni</p>
  `
  }
},
  ...
  diet: "vegan",
  title: {
    en: "Understanding different perspectives",
    es: "Entender diferentes perspectivas",
    hu: "Különböző nézőpontok megértése"
  },
  lesson: {
  en: `
    <p>People are shaped by culture, habits, emotions, and personal experiences when making decisions.</p>

    <p>And our mind naturally tends to support what we desire to be true — especially when something matters to us.</p>

    <p>This is a common human tendency, not specific to any one group, and it applies to everyone, including vegans.</p>

    <p>Understanding this can help us stay calmer and more open when we encounter anti-vegan perspectives 🌱</p>
  `,
  es: `
    <p>Las personas están influenciadas por la cultura, los hábitos, las emociones y las experiencias personales al tomar decisiones.</p>

    <p>Y nuestra mente tiende de forma natural a apoyar lo que deseamos que sea verdad — especialmente cuando algo es importante para nosotros.</p>

    <p>Es una tendencia humana común, no exclusiva de ningún grupo, y se aplica a todos, incluidos los veganos.</p>

    <p>Entender esto puede ayudarnos a mantener la calma y la apertura cuando encontramos perspectivas anti-veganas 🌱</p>
  `,
  hu: `
    <p>Az emberek döntéseit a kultúra, a szokások, az érzelmek és a személyes tapasztalatok is formálják.</p>

    <p>Az elménk pedig természetes módon hajlamos támogatni azt, amit szeretnénk igaznak látni — különösen akkor, ha valami fontos számunkra.</p>

    <p>Ez egy általános emberi működés, nem egyetlen csoportra jellemző, és mindenkire igaz, a vegánokra is.</p>

    <p>Ennek megértése segíthet nyugodtabban és nyitottabban reagálni az anti-vegan nézőpontokra 🌱</p>
  `
}
}
